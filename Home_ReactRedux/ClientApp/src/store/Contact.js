...
export const actionCreators = {
    ...
    requestContacts: () => async (dispatch, getState) => {
        ...
        const url = 'http://localhost:5002/api/Contacts/Contacts';
    ...
    saveContact: contact => async (dispatch, getState) => {
        ...
        const url = 'http://localhost:5002/api/Contacts/SaveContact';
    ...
    deleteContact: contactId => async (dispatch, getState) => {
        const url = 'http://localhost:5002/api/Contacts/DeleteContact/' + contactId;
        const requestOptions = {
            method: 'DELETE',
        };
        const request = new Request(url, requestOptions);
